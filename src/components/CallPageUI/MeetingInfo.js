...
const MeetingInfo = ({ user }) => {
  ...
  return (
    <>
      ...
      {close ? (<MeetingInfoContainer>
        <Header>
          <h3>Your meeting's ready</h3>
          <span class='material-icons-outlined' onClick={() => setclose(!close)}>
            <CloseIcon />
          </span>
        </Header>
        <Body>
          <Button>
            <i class='material-icons-outlined' style={{
          ...
          <LinkBox>
            <p>{callInput}</p>
            <span class='material-icons-outlined'><ContentCopyIcon /></span>
          </LinkBox>
          <InfoBox>
        ...
        : <div className='pointer_' >
          <span className='icons_more' style={{
           display: "flex",
