    ...
    return (
      <FooterContainer>
        <UserInfo>
          ...
          >
            {mic ? (<span className='icon'><Mic /></span>) : (<span className='icon'><Micoff /></span>)}
          </span>
        ...
        <FooterLeft>
          <div>
            ...
            <span class='material-icons-outlined'><ExpandLessIcon /></span>
          </div>
        </FooterLeft>
        ...
        <FooterMiddle>
          <div>
            ...
            >
              <span class='material-icons'>{mic ? (<span className='icon'><Mic /></span>) : (<span className='icon'><Micoff /></span>)}</span>
            </CallOptionContainer>
            ...
            >
              <span class='material-icons'>
                {videocam ? (<span className='icon'><VideocamIcon /></span>) : (<span><VideocamOffIcon /></span>) }
              </span>
            </CallOptionContainer>
          </div>
        </FooterMiddle>
        <FooterRight>
          <ControlOptionContainer>
            <div>
              <span class='material-icons-outlined'><ClosedCaptionIcon /></span>
              <p>Turn on Caption</p>
            </div>
          </ControlOptionContainer>
          <ControlOptionContainer>
            <div>
              <span class='material-icons-outlined'><PresentToAllIcon /></span>
              <p>Present Now</p>
            </div>
          </ControlOptionContainer>
          <ControlOptionContainer>
            <div>
              <span class='material-icons-outlined'><MoreVertIcon /></span>
            </div>
          </ControlOptionContainer>
        </FooterRight>
      </FooterContainer>
